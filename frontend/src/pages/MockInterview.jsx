...
import { Play, SkipForward, CheckCircle, Clock, RefreshCw } from 'lucide-react';
        ...
        <div className="mock-session">
          ...
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            <svg width="120" height="120" viewBox="0 0 120 120">
              ...
              <text x="60" y="56" textAnchor="middle" fill={timerColor} fontSize="24" fontWeight="800" fontFamily="Space Grotesk">{Math.floor(timeLeft/60)}:{String(timeLeft%60).padStart(2,'0')}</text>
            ...
            {!revealed ? (
              ...
              <div style={{ marginTop: 20 }}>
                ...
                <div style={{ marginTop: 16 }}>
                  <div style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 10 }}>How well did you know this? (1 = Poor, 5 = Perfect)</div>
                  <div style={{ display: 'flex', gap: 8 }}>
                    {[1,2,3,4,5].map(r => (
                      <button key={r} onClick={() => rate(r)} style={{
                        width: 40, height: 40, borderRadius: 10, border: `2px solid ${ratings[idx] === r ? '#8b5cf6' : 'var(--border)'}`,
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
            <button className="btn btn-ghost" onClick={() => { clearInterval(timerRef); setPhase('results'); }}>
              End Session
            </button>
